...
class KetemaReportNew extends Controller
{
    public function index(Request $request)
    {
        ...
        foreach ($woredas as $woreda) {
            ...
            //model members
            //TODO how do you know wheter higher officials are model or not
            {
                $row_model_members[1] = 
        ...
        return view('report.ketema_new', compact('zoneName', 'weseking_gudletin', 'abalat_age_education', 'abalat_mahberawi_bota', 'abalat_deant', 'wahio_count', 'tabia_count', 'plan_deant', 'plan_non_deant', 'plan_all', 'model_members', 'new_members_non_deant', 'new_members_deant', 'approved_new_members', 'grades', 'punishment', 'zobadatas', 'zoneCode'));
    }
}
