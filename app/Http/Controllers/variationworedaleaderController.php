...
class variationworedaleaderController extends Controller
{
    /**
    ...
    public function index(){
        ...
        // DB::table('woredas')->where('Mekelle', $Tabias)->pluck('name');
           ...
           return view('report.variationworedaleader', compact('Tabias','weredatat'));
    }
    ...
    {   
     ...
     // $Tabias = Tabia::all();
        ...
        $Tabias = DB::table('tabias')
           ...
           // DB::table('woredas')->where('Mekelle', $Tabias)->pluck('name');
           $count = DB::table('hitsuys') ->where('hitsuys.gender', '=', 'female') ->count();
           return view('customer', compact( 'count', 'Tabias'));
