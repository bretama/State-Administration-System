...
class FirstInstantLeadersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view ('leadership.firstinstantleadershipform',compact('data','zobadatas')); 
    }
    public function firstinstantleadersIndex()
    {
        //
        $data=FirstInstantLeader::all();  
        ...
        $zobadatas = DB::table("zobatats")->pluck("zoneName","zoneCode");     
        return view ('leadership.fleaderslist',compact('data','zobadatas','tabiadata','woredaname','woredadata'));
    }
    ...
    public function store(Request $request)
    {
       ...
       // $data->result14 = $request->result14;     
        ...
        return [true, "ጀማሪ ኣመራርሓ መምልኢ ማህደር ብትኽክል ተመዝጊቡ ኣሎ"];
