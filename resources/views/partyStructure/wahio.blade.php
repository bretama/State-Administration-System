...
@section('main-content')
			...
			<div class="box box-primary" role="tabpanel" data-example-id="togglable-tabs">
                      ...
                      <div id="myTabContent2" class="tab-content">
                       ...
                       <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-">መሰረታዊ ውዳበ  </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control">
                            <option>ምረፅ</option>
                            <option> ውዳበ 1 </option>
					   ...
					   <div class="form-group">
						...
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">  ዋህዮ     <span class="required">（*）</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
