...
@section('main-content')
   <div class=""> 
        ...
        <form method="GET" action= "{{URL('1stleaderslist')}}" class="form-inline">                           
            <label>ቕድሚ ኸዚ ዝተመዝገቡ ናይ ጀማሪ ኣመራርሓ መምልኢ ማህደር:</label>
        ...
        <div id="smartwizard">
            <ul>
                ...
                <li><a href="#step-4">ቅጥዒ 4<br /><small>ካብ ቑፅሪ 3 ክሳብ ቑፅሪ 8</small></a></li>
            </ul>
            
            <div>               
                <div id="step-1" class="">
                    <h3>1. ንኣጠቃላሊ ኣተሓሳስባን ግንዛበን ዝምልከት</h3>
                    <!-- sm=small screen,md=medium, xs=extra small, lg=large screen -->
                    <div class="form-group col-sm-12 col-md-12">                     
                        <label class="control-label col-md-3 col-sm-3" for="hitsuyID">መፍለይ ቑፅሪ ጀማሪ ኣመራርሓ:</label>
                    ...
                    <div class="form-group col-sm-12 col-md-12"> 
                        <label class="control-label" for="answer1">1.1 ንባዕሉ ካብ ዝኾነ ክራይ ኣካብነት ኣተሓሳስባን ተግባርን ሙሉእ ብሙሉእ ነፃ ኣብ ምኻንን ኣብ ካልኦት ንዝረኣዩ ጉድለታት ብትረት ኣብ ምቅላስን ፤ </label>
                        ...
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result1" type="number" min="0" max="10" placeholder="ዝረኸቦ ውፅኢት ካብ 10" name="Result1"  required="required">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-12 col-md-12">
                    <label class="control-label">1.3 ግልፅነት ዝምልከት</label>                     
                    ...
                    <div class="form-group col-sm-12 col-md-12">                     
                        ...
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result4" type="number" min="0" max="10" placeholder="ዝረኸቦ ውፅኢት ካብ 10" name="Result4"  required="required">
                        </div>
                    </div>

                    <div>                        
                    <p style="text-align:center">***ናይ ጀማሪ ኣመራርሓ መምልኢ ማህደር***</p>
                    </div>
                ...
                <div id="step-3" class="">
                    <h3>2. ኣብ ልምዓትን ሰናይ ምምሕዳርን ተግባራት ልኡኹ ብብቕዓት ንምፍፃም ዘለዎ ክእለት</h3>
                    <div class="form-group col-sm-12 col-md-12">                     
                        <label class="control-label" for="answer6">2.1 ኣብ ዝተዋፈረሉ ዓውደ ስራሕ ካብ ዘለዉ ኣባላት ውዳበ ዝለዓለ ውፅኢት ስራሕ ኣብ ምምዝጋብ ዘለዎ ኩነታት ፤</label>
                        <div class="col-sm-12 col-md-12">
                        ...
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result6" type="number" min="0" max="10" placeholder="ዝረኸቦ ውፅኢት ካብ 10" name="Result6"  required="required">
                        </div>
                    </div>
                    <div class="form-group col-sm-12 col-md-12"> 
                        ...
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result7" type="number" min="0" max="10" placeholder="ዝረኸቦ ውፅኢት ካብ 10" name="Result7"  required="required">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-12 col-md-12">                     
                        ...
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result8" type="number" min="0" max="10" placeholder="ዝረኸቦ ውፅኢት ካብ 10" name="Result8"  required="required">
                        </div>
                    </div>                    
                    ...
                    <div class="form-group col-sm-12 col-md-12">                     
                        ...
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result9" name="Result9"   type="number" min="0" max="15" placeholder="ዝረኸቦ ውፅኢት ካብ 15" required="required">
                        </div>
                    </div>
                ...
                <div id="step-4" class="">
                    ...
                    <div class="form-group col-sm-12 col-md-12">                     
                        ...
                        <div class="col-sm-3 col-md-3">
                            <input class="form-control" id="result10" name="Result10"   type="number" min="0" max="10" placeholder="ዝረኸቦ ውፅኢት ካብ 10" required="required">
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">       
                        ...
                        <div class="form-group col-md-12 col-sm-12 col-xs-12">                        
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                  <select class="form-control" id="members" name="members" required="required">
                                        <option selected disabled>~ጀማሪ ኣመራርሓ ምረፅ~</option>
                                    </select>
                              </div>                                
                        </div>
                    ...
                    <div class="deleteContent">
                        መፍለይ ቑፅሩ "<span class="hID text-danger"></span>" ዝኾነ ጀማሪ ኣመራርሓ ብትክክል ክጠፍአ ይድለ ድዩ  ? <span
...
$(document).on('click', '.search-modal', function() {
        ...
        $('.modal-title').text('ጀማሪ ኣመራርሓ ካብ ማህደር መድለይ');
        $('.deleteContent').hide();
        $('.searchContent').show();
        $('.formadder').hide();
        $('#myModal').modal('show');
    ...
    $('select[name="zone"]').on('change', function() {
        ...
        $('select[name="proposerWahio"]').on('change', function() {
            var stateID = $(this).val();
               ...
               if(stateID) {
                $.ajax({
                    url: 'myform2/ajax/firstinstantleader/'+stateID,
                    type: "GET",
                    dataType: "json",
                    success:function(data) {
                        ...
                        $('select[name="members"]').append('<option value="'+ " " +'">'+ "~ጀማሪ ኣመራርሓ ምረፅ~" +'</option>');
                        $.each(data, function(key, value) {
