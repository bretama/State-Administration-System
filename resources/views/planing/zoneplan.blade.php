        ...
        <tbody  id="products-list" name="products-list">
          ...
          <tr class="item{{$item->id}}" >
            ...
            <td><button class="edit-modal btn btn-info"
                data-info="{{$item->id}},{{$item->name}},{{$item->amount}}">
...
function fillmodalData(details){
    ...
    $('#planyear1').val(details[2]);
    $('#plantype1').val(details[3]);
    $('#amount1').val(details[4]);
    $('#descrpt1').val(details[5]);
        ...
        $.ajax({
            ...
            success: function(data) {
              if(data[0] == true){
                      ...
                      $(row[2]).html($('#planyear1').val());
                      $(row[3]).html($('#plantype1').val());
                      $(row[4]).html($('#amount1').val());
                      $(row[5]).html($('#descrpt1').val());
