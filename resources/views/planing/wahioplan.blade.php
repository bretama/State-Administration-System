        ...
        <table class="table table-borderless" id="table2">
          <thead>
            <tr>
              ...
              <th class="text-center">መለለዪ ዋህዮ</th>
          ...
          <tbody  id="products-list" name="products-list">
            @foreach ($data as $myindividual)
                <tr>
                  <td><input style="display: inline;" type="checkbox" class="checkbox" name="check[]" value="{{{ $myindividual->id }}}"></td>
                  <td>{{ $myindividual->id }}</td>  
                  <td>{{ $myindividual->wahioName }}</td>
                  <td>{{ $collectionyear[$myindividual->id] }}</td>
                </tr>
              @endforeach
          </tbody>
        </table>
