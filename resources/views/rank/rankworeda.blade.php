        ...
        <div class="">
            ...
            <tbody>
                        @foreach ($data as $myworeda)
                          <tr>
                            <td><input  style="display: inline;" type="checkbox" class="checkbox" name="check[]" value="{{{ $myworeda->woredacode }}}"><td>
                            <td class="hidden">{{ $myworeda->zoneCode }}</td>  
                            <td>{{ $myworeda->woredacode }}</td>                                                      
                            <td>{{ $myworeda->name }}</td>
                            <td>{{ $myworeda->isUrban }}</td>
                            <td>{{ $collectionyear[$myworeda->woredacode] }}</td>
                          </tr>                       
                        @endforeach    
                    </tbody>
                </table>
    ...
    $(document).on('click', '.add-modal', function() {
       if($('.checkbox:checked').length==0){
            ...
            $('.checkbox:checked').each(function(){
                // if(this.checked){
                  rows.push($(this).parent().parent().children()[6]);
                  var myVal=$(this).val();
                  idVals.push(myVal);            
                // }
            });
