			...
			<table class="table table-borderless" id="table2">
				<thead>
					<tr>
						...
						<th class="text-center">ደመወዝ ካብ</th>
						<th class="text-center">ደመወዝ ክሳብ</th>
						<th class="text-center">ፐርሰንት</th>
					...
					<tr class="item{{$item->code}}" >
						...
						<td>
                            <button class="edit-modal btn btn-info"
								data-info="{{$item->code}},{{$item->from}},{{$item->to}},{{$item->percent}}">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="from">ደመወዝ ካብ</label>
							<div class="col-sm-10">
								<input type="name" class="form-control" id="from">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="to">ደመወዝ ክሳብ</label>
							<div class="col-sm-10">
								<input type="name" class="form-control" id="to">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="percent">ፐርሰንት</label>
							<div class="col-sm-10">
								<input type="name" class="form-control" id="percent1">
							</div>
						</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="salaryfrom">ደመወዝ ካብ</label>
							<div class="col-sm-10">
								<input type="name" class="form-control" id="salaryfrom">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="salaryto">ደመወዝ ክሳብ</label>
							<div class="col-sm-10">
								<input type="name" class="form-control" id="salaryto">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="percent">ፐርሰንት</label>
							<div class="col-sm-10">
								<input type="name" class="form-control" id="percent">
							</div>
						</div>
...
function fillmodalData(details){
    ...
    $('#from').val(details[1]);
    $('#to').val(details[2]);
    $('#percent1').val(details[3].slice(0, -1));
