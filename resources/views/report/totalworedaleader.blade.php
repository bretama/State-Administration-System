...
<div class="box box-primary">
  ...
  <tr>
    <th rowspan="2">ዞባ</th>
    <th colspan="3"> ብፆታ</th>
    <th colspan="3">ብደረጃ ዕድመ</th>
    <th colspan="4"> ብደረጃ ትምህርቲ </th>
    <th colspan="2"> በዝሒ ክፍቲ ቦታ </th>
    <th colspan="2"> ዓ/ኣመራርሓ </th>
    <th colspan="2"> ብደረጃ ስርርዕ</th>
    <th colspan="2"> ስልጠና ላ/ኣመ</th>
    <th colspan="2"> ስልጠና ማ/ኣመራርሓ</th>
  </tr>
  <tr>
        <th>ተባ</th>
        <th>ኣነ</th>
...
<td ><?php $edusum = $edu1 + $edu2 + $edu3 + $edu4 + $edu5 + $edu6 + $edu7 + $edu8; echo $edusum?> </td> 
    ...
    ?> <?php $ageC = $age1C + $age2C + $age3C;$edu1C = $edu1C + $edu1; 
...
<div>
      <a href="{{ route('HtmlToPDF10') }}" class="btn btn-primary">Download in PDF</a>
  </div>
</br>
      </div>
    </div>
