...
<div class="box box-primary">
  ...
  <tbody> 
    ...
    <?php $i = 1; $mulueC= 0 ; $hitsuyC = 0 ; $dimir1 = 0; $age1C = 0; $count=0; $count1=0; $age1=0;$age2=0;$age3=0; $age2C = 0; 
    $edu1 = 0; 
    $edu2 = 0; $edu3 = 0; $edu4 = 0; $edu5= 0; $edu6 = 0; $edu7 = 0; $edu8 = 0; $edusum = 2;
    $age3C = 0; $edu1C = 0; 
...
<tr >
<td >{{$zob->zoneName}}</td>
<td ><?php $now= carbon::today(); $then=$now->subMonths(3); $count = DB::table('zoneplans')
 ->whereBetween('created_at', [$now,  $then])
-> where('amount', '=', 'ላዕለዋይ ኣመራርሓ')->count(); 
    echo $count?></td>
...
<td ><?php echo $age2; ?></td>
              ...
              $age3 = DB::table('approved_hitsuys')->join('hitsuys', 'approved_hitsuys.hitsuyID', '=', 'hitsuys.hitsuyID')
         //     -> where('plantype', '=', 'ላዕለዋይ ኣመራርሓ')
              ->whereBetween('approved_hitsuys.updated_at', [$now,  $then])
              ->whereBetween('hitsuys.dob', [$minDate3, $maxDate3]) ->where('hitsuys.hitsuyID','LIKE','0'.$i.'%')->count();
              ?>
...
<?php $edusum = $edu1 + $edu2 + $edu3 + $edu4 + $edu5 + $edu6 + $edu7 + $edu8; ?>  
  ...
  @endforeach
  <?php $i++; $mulueC= $mulueC + $count ; $hitsuyC = $hitsuyC + $count1; $dimir1 = $mulueC + $hitsuyC; $age1C = $age1C + $age1; $age2C = $age2C + $age2; $age3C = $age3C + $age3; 
    $ageC = $age1C + $age2C + $age3C; $edu1C = $edu1C + $edu1; 
...
<div>
      <a href="{{ route('HtmlToPDF4') }}" class="btn btn-primary">Download in PDF</a>
  </div>
</br>
      </div>
    </div>
