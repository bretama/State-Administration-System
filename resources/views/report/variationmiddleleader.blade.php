...
ወሰኽን ጉድለትን ማ/ኣመራርሓ ካብ ጠቕላላ ወረዳ ኣመራርሓ ወፃእ         
@endsection
...
<div class="box box-primary">
  ...
  <tr>
        ...
        <th rowspan="2" > ናብ ላ/ኣመራርሓ ምምልማል</th>
...
<td><?php $age1=0; ?> <?php $age2=0; ?> <?php  $age3=DB::table('approved_hitsuys')->join('dismisses', 'approved_hitsuys.hitsuyID', '=', 'dismisses.hitsuyID')
...
->count(); 
    echo $edu3?></td>
<td ><?php $edu4 = DB::table('approved_hitsuys')->join('dismisses', 'approved_hitsuys.hitsuyID', '=', 'dismisses.hitsuyID')
-> where('membershipType', '=', 'ማ/ኣመራርሓ')
...
-> where('membershipType', '=', 'ማ/ኣመራርሓ')
->where('dismisses.dismissReason', '=', 'nab laeleway amerariha milimal') 
->whereBetween('dismisses.created_at', [$now,  $then])
->where('approved_hitsuys.hitsuyID','LIKE','0'.$i.'%')
->count();  
    echo $edu7?></td>
...
<div>
      <a href="{{ route('HtmlToPDF6') }}" class="btn btn-primary">Download in PDF</a>
  </div>
</br>
      </div>
    </div>
