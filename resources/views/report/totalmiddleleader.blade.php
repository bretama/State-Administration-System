...
ህልዊ ማ/ኣመራርሓ ካብ ጠ/ወ/ኣመራርሓ ወፃእ ኣሃዛዊ መረዳእታ                          
@endsection
...
<td ><?php $edusum = $edu1 + $edu2 + $edu3 + $edu4 + $edu5 + $edu6 + $edu7 + $edu8; echo $edusum?> </td> 
    ...
    <?php $i++; $mulueC= $mulueC + $count ; $hitsuyC = $hitsuyC + $count1; $dimir1 = $mulueC + $hitsuyC; $age1C = $age1C + $age1; $age2C = $age2C + $age2; $age3C = $age3C + $age3; $edu1C = $edu1C + $edu1; 
...
<div>
      <a href="{{ route('HtmlToPDF7') }}" class="btn btn-primary">Download in PDF</a>
  </div>
</br>
      </div>
    </div>
