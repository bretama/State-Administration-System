...
@if (count($errors) > 0)
          ...
          @endif
	<form id="profile-form" method="POST" action= "{{URL('hitsuy')}}" data-parsley-validate class="form-horizontal form-label-left">
		<div class="col-md-5">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-2" for="occupation">ዝተዋፈርሉ ስራሕ:<span class="text-danger">*</span></label>
                  <div class="col-sm-4">
            ...
            <label  class="radio-inline">
                    ...
                    ካልእ
							...
							<div class="form-group tabia">
								<label class="col-md-2 control-label" for="proposerWidabe">ዝመልመሎ መ.ው.</label>
								<div class="col-md-4">
								...
								<label class="col-md-2 control-label" for="proposerWahio">ዝመልመሎ ዋህዮ</label>
								<div class="col-md-4">
