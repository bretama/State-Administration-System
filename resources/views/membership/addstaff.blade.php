          ...
          <form class="form-horizontal" role="form">
            {{ csrf_field() }}
                    <div class="form-group col-sm-12 col-md-12">                     
                        <label class="control-label col-md-3 col-sm-3" for="firstname1">ሽም ተጠቀምቲ:</label>
                        <div class="col-md-3 col-sm-3 col-xs-3">
                            <input type="text" id="firstname1" name="firstname1" class="form-control" required >
                        </div>                                                
                    </div>
                    <div class="form-group col-sm-12 col-md-12">
                        <label class="control-label col-md-3 col-sm-3" for="lastname1">ሽም ኣቦ:</label>
                        <div class="col-md-3 col-sm-3 col-xs-3">
                            <input type="text" id="lastname1" name="lastname1" class="form-control" required >
                        </div>
                    </div>
                    <div class="form-group col-sm-12 col-md-12">
                        <label class="control-label col-md-3 col-sm-3" for="email1">ኢሜይል:</label>
                        <div class="col-md-3 col-sm-3 col-xs-3">
                            <input type="email" id="email1" name="email1" class="form-control" required >
                        </div>
                    </div>
                    <div class="form-group col-sm-12 col-md-12">
                        <label class="control-label col-md-3 col-sm-3" for="pass1">ይሕለፍ ቃል:</label>
                        <div class="col-md-3 col-sm-3 col-xs-3">
  ...
  <div id="myModaladd" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-horizontal" method="POST" action= "{{URL('adduser')}}" role="form">
            {{ csrf_field() }}
                    <div class="form-group col-sm-12 col-md-12">                     
                        <label class="control-label col-md-3 col-sm-3" for="firstname">ሽም ተጠቀምቲ:</label>
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <input type="text" id="firstname" name="firstname" class="form-control" required >
                        </div>                                                
                    </div>
                    <div class="form-group col-sm-12 col-md-12">
                        <label class="control-label col-md-3 col-sm-3" for="lastname">ሽም ኣቦ:</label>
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <input type="text" id="lastname" name="lastname" class="form-control" required >
                        </div>
                    </div>
                    <div class="form-group col-sm-12 col-md-12">
                        <label class="control-label col-md-3 col-sm-3" for="myemail">ኢሜይል:</label>
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <input type="email" id="myemail" name="myemail" class="form-control" required >
                        </div>
                    </div>
                    <div class="form-group col-sm-12 col-md-12">
                        <label class="control-label col-md-3 col-sm-3" for="usertype">ዓይነት ተጠቃሚ:</label>
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <select class="form-control" id="usertype" name="usertype" required="required">
                              <option selected disabled>~ምረፅ~</option>
                              <option value="admin" >ኣድሚን</option>
                              <option value="staff" >ስታፍ</option>
                              <option value="recorder" >ሪከርደር</option>                 
                            </select>
                        </div>
                    </div>
                    <div class="form-group col-sm-12 col-md-12">
                        <label class="control-label col-md-3 col-sm-3" for="mypass">ይሕለፍ ቃል:</label>
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <input type="password" id="mypass" name="mypass" class="form-control" required>
                        </div>
                        </div>
            <p class="fname_error error text-center alert alert-danger hidden"></p>
...
@endsection
  ...
  $(document).on('click', '.add-modal', function() {
        ...
        $('.modal-title').text('ሓደሽቲ ተጠቀምቲ መምዝገቢ');
        $('.deleteContent').hide();
        $('.form-horizontal').show();
