            ...
            <div>               
                <div id="step-1" class="">
                    ...
                    <div class="form-group col-sm-12 col-md-12">                     
                        <label class="control-label col-md-3 col-sm-3" for="hitsuyID">መፍለይ ቑፅሪ ሰብ ሞያ ኣባላት ህወሓት:</label>
                ...
                <div id="step-2" class="">
                    ...
                    <div class="form-group col-sm-12 col-md-12">                     
                        ...
                        <div class="col-sm-12 col-md-3">
                            <input class="form-control" id="result5" type="number" min="0" max="10" placeholder="ዝረኸቦ ውፅኢት ካብ 10" name="Result5"  required="required">
                        </div>
                    </div>               
                   <div class="form-group col-sm-12 col-md-12">                     
